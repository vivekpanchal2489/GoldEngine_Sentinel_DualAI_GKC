...
input bool   InpEnableZone1Trading  = false;  // Enable Trading in Zone 1 (Asian Session: 03:30 AM - 01:30 PM IST) [FALSE = Curfew/Standby]
...
bool IsZoneTradingAllowed(string &zoneBlockedReason)
{
   ...
   // 2. Zone 1: Asian Session (03:30 AM - 01:30 PM IST)
